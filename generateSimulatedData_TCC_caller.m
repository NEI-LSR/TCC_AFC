...
%     plot([cart(:,1);cart(:,2)]' - [stimCols(1,:),stimCols(2,:)])
    ...
    [nll, data] = generateSimulatedData_TCC([],...
        'nTrials',nTrials, ...
        'nBig',nBig, ...
        'nSmall',nSmall);
...
f = @(x)generateSimulatedData_TCC(x,... % anonymous function so that we can pass additional parameters
...
% [nll, simdata] = generateSimulatedData_TCC(x,... 
%     'choiceInds',choiceInds,...
%     'cueInd',cueInd,...
%     'response',response,...
%     'nTrials',nTrials,...
